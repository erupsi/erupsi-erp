...
function EMarket({ onEdit, onAddProduct, onOpenCart, cartItemsCount }) {
                ...
                {products.map((product) => (
                    <div key={product.id} className="relative">
                        <a href="https://youtube.com" target='_blank'>
                            <img src={`/ecommerce/eMarket/${product.image_url}`} alt="" />
                            ...
                            <div className='review'>
                                ...
                                <p>{product.avgrating} | {product.hassold} terjual</p>
                            </div>
                            </div>
                        </a>
                    ...
                    <div className="dropdown-container relative">
                        <button 
                            ...
                            onClick={(e) => {
                                e.preventDefault();
                                toggleDropdown(product.id_products);
                            }}
                            >
                            <svg 
                                fill="#3d3846" 
                        ...
                        {openDropdown === product.id_products && (
