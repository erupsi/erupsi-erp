 ...
 * This function only allows specific fields
 * ('full_name', 'email', 'department', 'position', 'is_active') to be updated.
    ...
    // Cek apakah user ada (opsional, tapi disarankan untuk respons 404 yang akurat)
        ...
        if (!updatedEmployee.success) {
            return res.status(400)
                .json({message: "Tidak ada properti yang valid untuk diupdate atau pegawai tidak ditemukan."});
        }
