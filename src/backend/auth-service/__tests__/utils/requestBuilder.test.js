...
const requestBuilder = require('../../src/utils/requestBuilder'); // Sesuaikan path jika perlu
...
describe('requestBuilder', () => {
  ...
  test('should build and send a GET request without a body', async () => {
    ...
    expect(jwt.sign).toHaveBeenCalledWith(
      { roles: ['AUTH_SERVICE'] },
      expect.any(String), // We don't care about the exact key, just that it's a string
  ...
  const response = await requestBuilder(mockUrl, mockMethod, mockEmployeeData);
