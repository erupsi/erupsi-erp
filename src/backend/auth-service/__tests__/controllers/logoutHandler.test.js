...
describe("logoutHandler Controller", () => {
    ...
    // --- Skenario Berhasil ---
    test("should successfully delete token and return 200 with success message",
        async () => {
            const mockRequest = {
                cookies: {
            ...
            expect(mockResponse.clearCookie)
            ...
            expect(mockResponse.json)
                .toHaveBeenCalledWith({message: "Logout successful"});
        });
