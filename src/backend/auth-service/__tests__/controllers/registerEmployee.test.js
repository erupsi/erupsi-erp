...
describe("registerEmployee Controller", () => {
    ...
    // --- Skenario Berhasil ---
    test("should return 200 with success message on successful registration",
        async () => {
            uuidv4.mockReturnValue("mock-uuid-123");
            authService
                .addEmployeeRequestToUrm.mockResolvedValue({success: true});
    ...
    // Siapkan mock untuk throw error
        authService.addEmployeeRequestToUrm
